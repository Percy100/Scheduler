...
public class DisplaySchedule extends JFrame implements ActionListener{
	
	Scheduler sh;
	
	public DisplaySchedule(Scheduler sh) {
		this.sh = sh;
...
//	    f.getContentPane().add(p5);
	...
	public void actionPerformed(ActionEvent e) {
		...
		sh.displayDaySchedule(sh.makeCalendarFromUserInput(textfield3.getText()));
	}
