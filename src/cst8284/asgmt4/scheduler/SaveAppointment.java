...
public class SaveAppointment extends JFrame implements ActionListener{
	
	Scheduler sh;
	
	public SaveAppointment(Scheduler sh) {
		this.sh = sh;
	...
	private void loadAppointmentDialog() {
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				sh.saveAppointment(sh.makeAppointmentFromUserInput(textfield1.getText(), textfield2.getText(), textfield3.getText(), textfield4.getText(), textfield5.getText()));
			}
